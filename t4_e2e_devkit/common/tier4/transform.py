...
#
# Source : t4devkit:t4_devkit/dataclass/transform.py
# Commit : 4496b3e
...
from t4_e2e_devkit.common.tier4.converter import to_quaternion
from t4_e2e_devkit.common.tier4.typing import Matrix3x3, Matrix4x4, Quaternion, Vector3

if TYPE_CHECKING:
    from t4_e2e_devkit.common.tier4.typing import Matrix4x4Like, RotationLike, Vector3Like
