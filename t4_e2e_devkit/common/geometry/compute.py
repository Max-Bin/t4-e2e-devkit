...
#
# Source : nuplan:nuplan/common/geometry/compute.py
# Commit : e924167
...
from t4_e2e_devkit.common.actor_state.oriented_box import Dimension, OrientedBox
from t4_e2e_devkit.common.actor_state.state_representation import Point2D, StateSE2
from t4_e2e_devkit.common.actor_state.vehicle_parameters import get_pacifica_parameters
from t4_e2e_devkit.common.geometry.transform import translate_laterally, translate_longitudinally
