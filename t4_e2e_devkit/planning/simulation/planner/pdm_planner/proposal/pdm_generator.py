...
from t4_e2e_devkit.common.geometry.transform import transform
...
from t4_e2e_devkit.planning.simulation.planner.pdm_planner.utils.pdm_array_representation import state_array_to_ego_states
from t4_e2e_devkit.planning.simulation.planner.pdm_planner.utils.pdm_enums import LeadingAgentIndex, StateIDMIndex, StateIndex
from t4_e2e_devkit.planning.simulation.planner.pdm_planner.utils.pdm_geometry_utils import normalize_angle
...
class PDMGenerator:
    ...
    def _update_leading_agents(self, lateral_batch_idcs: List[int], time_idx: int) -> None:
        ...
        if not update_leading_agent:
            ...
            intersecting_objects: List[str] = self._get_intersecting_objects(lateral_batch_idcs, time_idx)
